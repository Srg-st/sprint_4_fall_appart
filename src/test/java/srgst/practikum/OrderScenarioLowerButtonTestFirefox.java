...
public class OrderScenarioLowerButtonTestFirefox {
    ...
    public OrderScenarioLowerButtonTestFirefox(String name, String surname, String adress, String metro, String telephone, String dateDelivery, String comment) {
        this.name = name;
