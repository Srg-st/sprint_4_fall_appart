...
import org.openqa.selenium.WebDriver;
    ...
    public class MainQuestionPageTest {
        private WebDriver driver;

        private int index;
        private final String expectedTextAnswer;

        public MainQuestionPageTest(int index, String expectedTextAnswer) {
            this.index = index;
        ...
        public void checkTextInAnswer(){
            ...
            mainPageScooter.scrollToQuestionsBlock();
            mainPageScooter.checkTextOnAnswer(index, expectedTextAnswer);
        }
